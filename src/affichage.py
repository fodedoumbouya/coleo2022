...
def drawImageSet(dataset,labels,fileNamePrefix=None,datadir=".", title="Figure"):
    for i,pkey in enumerate(dataset.keys()):
        ...
        show_image_wihtout_null_false(dataset[pkey],datadir+pkey,labels,outfilename=fileName,figureNumber=i, title=title)


def show_image_wihtout_null_false(data, imfFile, labels, outfilename=None , figureNumber = 0, title="Figure"):
